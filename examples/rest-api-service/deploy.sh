...
docker build --platform linux/amd64 -t rest-api:${IMAGE_TAG} "$SCRIPT_DIR"
docker tag rest-api:${IMAGE_TAG} ${ECR_URL}:${IMAGE_TAG}
docker tag rest-api:${IMAGE_TAG} ${ECR_URL}:latest
