...
See [detailed architecture documentation](https://github.com/jonmatum/terraform-aws-serverless-modules/tree/main/examples/openapi-rest-api/architecture.md) for comprehensive diagrams including:
