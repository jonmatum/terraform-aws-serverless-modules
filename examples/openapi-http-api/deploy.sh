...
docker build --platform linux/amd64 -t openapi-http:${IMAGE_TAG} "$SCRIPT_DIR"
docker tag openapi-http:${IMAGE_TAG} ${ECR_URL}:${IMAGE_TAG}
docker tag openapi-http:${IMAGE_TAG} ${ECR_URL}:latest
